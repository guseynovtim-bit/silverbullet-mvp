    ...
    <div className="max-w-5xl mx-auto p-6 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="p-6 bg-white border rounded-xl shadow-sm">
          ...
          <p className="mt-2 text-lg text-gray-800 line-clamp-3">{summary.for_c_level || SUMMARY_PLACEHOLDER}</p>
        </div>
        <div className="p-6 bg-white border rounded-xl shadow-sm">
          <h3 className="text-sm text-gray-500 font-medium">Для проектного офиса</h3>
          <p className="mt-2 text-lg text-gray-800 line-clamp-3">{summary.for_project_office || SUMMARY_PLACEHOLDER}</p>
        </div>
        <div className="p-6 bg-white border rounded-xl shadow-sm">
          <h3 className="text-sm text-gray-500 font-medium">Для продуктовой команды</h3>
          <p className="mt-2 text-lg text-gray-800 line-clamp-3">{summary.for_product_team || SUMMARY_PLACEHOLDER}</p>
        </div>
      </div>
